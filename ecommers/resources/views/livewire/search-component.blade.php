		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>Ranschool Store Product</span></li>
				</ul>
			</div>
			<div class="row">
				...
				<div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
					...
					<div class="banner-shop">
						<a href="#" class="banner-link">
							<figure><img src="{{ asset('assets/images/bestpr.png') }}" alt="" width=100%></figure>
						</a>
					</div>

					<div class="wrap-shop-control">

						<h1 class="shop-title">Ranschool Store Product</h1>
